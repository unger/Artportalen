namespace Artportalen.Sample.Scheduling
{
    ...
    public class DownloadTodaysSightingsJob : IJob
    {
        public void Execute(IJobExecutionContext jobContext)
        {
            Console.WriteLine("DownloadTodaysSightingsJob started: {0}", DateTimeOffset.Now);
            ...
            downloadSightings.DownloadAllTodaysSightings();
        }
    }
}
